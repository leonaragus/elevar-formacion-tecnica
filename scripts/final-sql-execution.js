...
async function executeFinalSQL() {
  try {
    console.log('Ejecutando SQL final...');
    ...
    // Primero, intentar crear la función exec_sql usando un método alternativo
    console.log('Creando función exec_sql...');
    
    // Usar el método RPC con una función existente para crear la función
