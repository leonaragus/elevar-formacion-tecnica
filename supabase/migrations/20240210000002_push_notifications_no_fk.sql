-- Solución temporal: Crear las tablas sin foreign keys primero
-- Luego agregaremos las foreign keys manualmente después de verificar los tipos
...
CREATE TABLE push_subscriptions (
  ...
  user_email TEXT,
  curso_id TEXT, -- Temporalmente sin foreign key
